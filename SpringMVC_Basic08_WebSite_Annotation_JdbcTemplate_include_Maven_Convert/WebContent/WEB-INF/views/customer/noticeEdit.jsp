					...
					<div id="notice-article-detail" class="article-detail margin-large" >						
						<dl class="article-detail-row">
							...
							<dd class="article-detail-data">
									  <input name="seq" value="${notice.seq}" hidden/>
						...
						<dl class="article-detail-row">
							...
							<dd class="article-detail-data">
								&nbsp;<input type="file" id="txtFile" name="files[0]" value="${notice.fileSrc}" />
							</dd>
						</dl>
						<dl class="article-detail-row">
							<dt class="article-detail-title">
							...
							<dd class="article-detail-data">
								&nbsp;<input type="file" id="txtFile" name="files[1]" value="${notice.fileSrc2}" />
							</dd>
						</dl>
