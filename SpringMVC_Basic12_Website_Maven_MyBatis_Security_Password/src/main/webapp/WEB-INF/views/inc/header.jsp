...
<div id="header">
	<div class="top-wrapper">
		...
		<ul id="loginmenu" class="block_hlist">
			...
			<!-- 3번 spring taglib -->
			<se:authorize access="!hasRole('ROLE_USER')&&!hasRole('ROLE_ADMIN')">
				<li>
		...
		<ul id="membermenu" class="clear">
			<li><a href="${pageContext.request.contextPath}/joinus/memberconfirm.htm"><img src="${pageContext.request.contextPath}/images/menuMyPage.png" alt="마이페이지" /></a>
			</li>
